...
<%
	...
	String geturl = "http://asp1.krx.co.kr/servlet/krx.asp.XMLSise?code="+key;
...
<script type="text/javascript" src="<%=context%>/resources/search_stock/js/common.js"></script>
<link rel="stylesheet" type="text/css" href="<%=context%>/resources/search_stock/css/stockinfo.css"/>
<title>실시간시세</title>
</head>
<body>
