...
//--------------------------------------1------------------------------------------------	DaeCha_data			
				...
				System.out
						.println("year1GuSungRate==" + daeCha_data.getNamedItem("year1GuSungRate" + i).getNodeValue());
				System.out.println(
						"year1JungGamRate==" + daeCha_data.getNamedItem("year1JungGamRate" + i).getNodeValue());
				System.out.println("year2Money==" + daeCha_data.getNamedItem("year2Money" + i).getNodeValue());
				System.out
						.println("year2GuSungRate==" + daeCha_data.getNamedItem("year2GuSungRate" + i).getNodeValue());
				System.out.println(
						"year2JungGamRate==" + daeCha_data.getNamedItem("year2JungGamRate" + i).getNodeValue());
				System.out.println("year3Money==" + daeCha_data.getNamedItem("year3Money" + i).getNodeValue());
				System.out
						.println("year3GuSungRate==" + daeCha_data.getNamedItem("year3GuSungRate" + i).getNodeValue());
				System.out.println(
						"year3JungGamRate==" + daeCha_data.getNamedItem("year3JungGamRate" + i).getNodeValue());
...
//--------------------------------------2------------------------------------------------				
				...
				System.out
						.println("year1JungGamRate==" + sonIk_data.getNamedItem("year1JungGamRate" + i).getNodeValue());
				...
				System.out
						.println("year2JungGamRate==" + sonIk_data.getNamedItem("year2JungGamRate" + i).getNodeValue());
				...
				System.out
						.println("year3JungGamRate==" + sonIk_data.getNamedItem("year3JungGamRate" + i).getNodeValue());
...
//--------------------------------------3------------------------------------------------				
				...
				System.out.println(
						"year1JungGamRate==" + cashFlow_data.getNamedItem("year1JungGamRate" + i).getNodeValue());
				System.out.println("year2Money==" + cashFlow_data.getNamedItem("year2Money" + i).getNodeValue());
				System.out.println(
						"year2JungGamRate==" + cashFlow_data.getNamedItem("year2JungGamRate" + i).getNodeValue());
				System.out.println("year3Money==" + cashFlow_data.getNamedItem("year3Money" + i).getNodeValue());
				System.out.println(
						"year3JungGamRate==" + cashFlow_data.getNamedItem("year3JungGamRate" + i).getNodeValue());
...
//		return "redirect:/daecha/insert.do";
	...
	// financialInfo 정보 가져오기 연습2
	@RequestMapping("finan2.do")
	public String finan2(@ModelAttribute DaeCha_dataDTO dto, HttpServletRequest request) {
		System.out.println("finan2===");
		String s_name = "";
		String num = "";
//			String num = request.getParameter("num");
		try {
			FileInputStream file = new FileInputStream("c:/inst/Data/s_name/test.xlsx");
			...
			for (rowindex = 0; rowindex < rows; rowindex++) {
				...
				if (row != null) {
					...
					// 종목 있는 지 확인후 추가 하기 
					String check = daechaService.check(num);
					if(check.equals("0")) {
					...
					try {
						...
						for (int i = 0; i < daeCha_data_length; i++) {
							...
							System.out.println("hangMok==" + daeCha_data.getNamedItem("hangMok" + i).getNodeValue());
							System.out.println(
									"year1Money==" + daeCha_data.getNamedItem("year1Money" + i).getNodeValue());
							System.out.println("year1GuSungRate=="
									+ daeCha_data.getNamedItem("year1GuSungRate" + i).getNodeValue());
							System.out.println("year1JungGamRate=="
									+ daeCha_data.getNamedItem("year1JungGamRate" + i).getNodeValue());
							System.out.println(
									"year2Money==" + daeCha_data.getNamedItem("year2Money" + i).getNodeValue());
							System.out.println("year2GuSungRate=="
									+ daeCha_data.getNamedItem("year2GuSungRate" + i).getNodeValue());
							System.out.println("year2JungGamRate=="
									+ daeCha_data.getNamedItem("year2JungGamRate" + i).getNodeValue());
							System.out.println(
									"year3Money==" + daeCha_data.getNamedItem("year3Money" + i).getNodeValue());
							System.out.println("year3GuSungRate=="
									+ daeCha_data.getNamedItem("year3GuSungRate" + i).getNodeValue());
							System.out.println("year3JungGamRate=="
									+ daeCha_data.getNamedItem("year3JungGamRate" + i).getNodeValue());
						...
						for (int i = 0; i < sonIk_data_length; i++) {
							...
							System.out.println("hangMok==" + sonIk_data.getNamedItem("hangMok" + i).getNodeValue());
							System.out
									.println("year1Money==" + sonIk_data.getNamedItem("year1Money" + i).getNodeValue());
							System.out.println("year1GuSungRate=="
									+ sonIk_data.getNamedItem("year1GuSungRate" + i).getNodeValue());
							System.out.println("year1JungGamRate=="
									+ sonIk_data.getNamedItem("year1JungGamRate" + i).getNodeValue());
							System.out
									.println("year2Money==" + sonIk_data.getNamedItem("year2Money" + i).getNodeValue());
							System.out.println("year2GuSungRate=="
									+ sonIk_data.getNamedItem("year2GuSungRate" + i).getNodeValue());
							System.out.println("year2JungGamRate=="
									+ sonIk_data.getNamedItem("year2JungGamRate" + i).getNodeValue());
							System.out
									.println("year3Money==" + sonIk_data.getNamedItem("year3Money" + i).getNodeValue());
							System.out.println("year3GuSungRate=="
									+ sonIk_data.getNamedItem("year3GuSungRate" + i).getNodeValue());
							System.out.println("year3JungGamRate=="
									+ sonIk_data.getNamedItem("year3JungGamRate" + i).getNodeValue());
						...
						for (int i = 0; i < cashFlow_data_length; i++) {
							...
							System.out.println("hangMok==" + cashFlow_data.getNamedItem("hangMok" + i).getNodeValue());
							System.out.println(
									"year1Money==" + cashFlow_data.getNamedItem("year1Money" + i).getNodeValue());
							System.out.println("year1JungGamRate=="
									+ cashFlow_data.getNamedItem("year1JungGamRate" + i).getNodeValue());
							System.out.println(
									"year2Money==" + cashFlow_data.getNamedItem("year2Money" + i).getNodeValue());
							System.out.println("year2JungGamRate=="
									+ cashFlow_data.getNamedItem("year2JungGamRate" + i).getNodeValue());
							System.out.println(
									"year3Money==" + cashFlow_data.getNamedItem("year3Money" + i).getNodeValue());
							System.out.println("year3JungGamRate=="
									+ cashFlow_data.getNamedItem("year3JungGamRate" + i).getNodeValue());
					...
					System.out.println("주식번호=" + value2);
				}
			} // for 1 끝 행을 읽어오는 for문
//			System.out.println("담긴1번째값=" + value2.get(0));
			}// 값이 있는지 체크하는  if문 닫기 
		} catch (Exception e) {
			e.printStackTrace();
		}
